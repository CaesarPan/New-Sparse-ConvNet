        ...
        if cifar == 10:
            for i in range(5):
                ...
                if (aug):
                    ...
                    #flipped_data = data_aug._random_flip_leftright(cropped_data)
...
def maybe_download_and_extract(cifar):
    ...
    """
    main_directory = "./"
    data_directory ="cifar_" + str(cifar) + "/"
